...
func (e *Exchange) BulkCancel(cancels []types.CancelRequest) (*types.CancelResponse, error) {
	...
	for i, cancel := range cancels {
		...
		cancelWires[i] = utils.NewOrderedMap(
			"a", asset,
			"o", cancel.Oid,
		)
	}
...
func (e *Exchange) SpotDeployUserGenesis(
	...
	action := utils.NewOrderedMap(
		"type", "spotDeploy",
		"userGenesis", utils.NewOrderedMap(
			"token", token,
...
func (e *Exchange) SpotDeployFreezeUser(token int, user string, freeze bool) (*types.DefaultResponse, error) {
	...
	action := utils.NewOrderedMap(
		"type", "spotDeploy",
		"freezeUser", utils.NewOrderedMap(
			"token", token,
			"user", strings.ToLower(user),
			"freeze", freeze,
		),
...
func (e *Exchange) spotDeployTokenActionInner(variant string, token int) (*types.DefaultResponse, error) {
	...
	action := utils.NewOrderedMap(
		"type", "spotDeploy",
		variant, utils.NewOrderedMap("token", token),
	)
...
func (e *Exchange) SpotDeployRegisterSpot(baseToken int, quoteToken int) (*types.DefaultResponse, error) {
	...
	action := utils.NewOrderedMap(
		"type", "spotDeploy",
		"registerSpot", utils.NewOrderedMap("tokens", []int{baseToken, quoteToken}),
	)
...
func (e *Exchange) SpotDeployRegisterHyperliquidity(
	...
	registerHL := utils.NewOrderedMap(
		"spot", spot,
...
func (e *Exchange) SpotDeploySetDeployerTradingFeeShare(token int, share string) (*types.DefaultResponse, error) {
	...
	action := utils.NewOrderedMap(
		"type", "spotDeploy",
		"setDeployerTradingFeeShare", utils.NewOrderedMap("token", token, "share", share),
	)
...
func (e *Exchange) PerpDeployRegisterAsset(
	...
	if schema != nil {
		...
		schemaWire = utils.NewOrderedMap(
	...
	action := utils.NewOrderedMap(
		"type", "perpDeploy",
		"registerAsset", utils.NewOrderedMap(
			"maxGas", maxGas,
			"assetRequest", utils.NewOrderedMap(
				"coin", coin,
				"szDecimals", szDecimals,
				"oraclePx", oraclePx,
...
func (e *Exchange) CValidatorRegister(
	...
	action := utils.NewOrderedMap(
		...
		"register", utils.NewOrderedMap(
			"profile", utils.NewOrderedMap(
				"node_ip", utils.NewOrderedMap("Ip", nodeIP),
				"name", name,
...
func (e *Exchange) CValidatorChangeProfile(
	...
	var nodeIPValue any
	if nodeIP != nil {
		nodeIPValue = utils.NewOrderedMap("Ip", *nodeIP)
	} else {
		nodeIPValue = nil
	}
